(function () {
    ...
    var db = {
        ...
        loadData: function (filter) {
            return $.grep(this.clients, function (client) {
                return (!filter.Ad || client.Ad.indexOf(filter.Ad) > -1)
                    && (!filter.Soyad || client.Soyad.indexOf(filter.Soyad) > -1)
                    && (!filter.Email || client.Email.indexOf(filter.Email) > -1)
                    && (filter.Telefon === undefined || client.Telefon === filter.Telefon)
    ...
    db.clients = [
        ...
        },
        {
            "Ad": "Rübabə",
            "Soyad": "Şabanova",
            "Email": "sabanovarubabe@gmail.com",
            "Telefon": "0503037483",
            "Status": 4
        },
        {
            "Ad": "Tərlan",
            "Soyad": "Soltanov",
            "Email": "soltanov.terlan04@outlook.com",
            "Telefon": "0552148467",
            "Status": 4
        },
        {
